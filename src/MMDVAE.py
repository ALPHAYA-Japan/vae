...
class MMDVAE:
    ...
    #
    #................................................................................
    def compute_mmd(self, x, y):   # [batch_size, z_dim] [batch_size, z_dim]
    ...
    def create_optimizer(self):
        # Compare the generated with true samples from a standard Gaussian,
        # and compute their MMD distance
        true_samples= tf.random_normal(tf.stack([self.batch_size, self.latent_dim]))
        loss_mmd    = self.compute_mmd(true_samples, self.encoded)
        # Negative log likelihood
        loss_nll    = tf.reduce_mean(tf.square(self.decoded - self.en_input))
        self.de_loss= loss_nll + loss_mmd
